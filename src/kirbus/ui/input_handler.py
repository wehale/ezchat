"""InputMixin — key handling and command routing for the kirbus UI."""
from __future__ import annotations

import curses
import threading

from kirbus.ui.models import SCRATCH_PEER, BACK_ENTRY, RESERVED_CHANNELS
from kirbus.ui.theme import list_themes, set_theme
...
/server-mode <mode>          switch auth mode (open/password/allowlist)"""
    ...
    def _handle_command(self, raw: str) -> None:
        ...
        if cmd in ("/quit", "/q", "/exit"):
            ...
            from kirbus.store.peers import set_peer_blocked
    ...
    def _handle_channel_command(self, arg: str) -> None:
        from kirbus.ui.models import Channel, RESERVED_CHANNELS
