...
def net_thread(ui, args, stop: threading.Event) -> None:
    ...
    async def _handle_conn(conn) -> None:
        ...
        try:
            from kirbus.store.peers import load_peers as _lp
        ...
        try:
            from kirbus.store import upsert_peer
    ...
    async def _run_registry(registry_url: str) -> None:
        from kirbus.net.registry_client import fetch_servers, verify_server_password
